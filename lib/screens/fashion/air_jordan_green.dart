...
class Jordan2 extends StatelessWidget {
  const Jordan2({Key? key}) : super(key: key);
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        color: Colors.grey[100],
                        borderRadius: BorderRadius.circular(20)),
                    child: Image.asset("images/greenback2.png"),
                  ),
                  SizedBox(
                    width: 10,
                  ),
                  Container(
                    ...
                    decoration: BoxDecoration(
                        color: Colors.grey[100],
                        borderRadius: BorderRadius.circular(20)),
                    child: Image.asset("images/greenangle.png"),
                  ),
                  SizedBox(
                    width: 10,
                  ),
                  Container(
                    ...
                    decoration: BoxDecoration(
                        color: Colors.grey[100],
                        borderRadius: BorderRadius.circular(20)),
                    child: Image.asset("images/greenrback.png"),
                  ),
                  SizedBox(
                    width: 20,
                  ),
